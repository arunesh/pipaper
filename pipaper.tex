...
(Whisper protocol), IPFS, Neo, EOS alongwith some of the emerging projects in this space. Our approach includes
...
\begin{itemize}
    \item {\em Location independent routing:} Location independent routing refers to a class of techniques for locating objects based on content rather than
        ...
        content using the Kademlia routing protocol. This might be a desirable property depending on the application (content lookup vs
