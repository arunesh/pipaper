...
\thanks{Both authors are currently working at Picolo Labs Inc.}}% <-this % stops a space
...
% The paper headers
\markboth{Extended Abstract submission to Stanford CBR Conference, 2019.}%
{Mishra \MakeLowercase{\textit{et al.}}: How to design a fast Peer-peer overlay network}
...
Blockchain and distributed ledger technologies define protocols that allow large, ad-hoc, groups of users to transfer
value between each other. They have further evolved into a computing and decentralized app (dapp) platform \cite{eth_wc}. This
