...
This short writeup discusses ongoing work as part of the Picolo Project \cite{picolo}. The goal of the Picolo project is
...
existing p2p overlay designs that support popular blockchains and applications today. Section \ref{sec:exp} discusses
what our expected contributions would look like by the conference date. 
